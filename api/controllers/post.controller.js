    ...
    try{
        ...
        await prisma.post.update({
            ...
            data: {
                ...
                images: postData.images,  // Assuming images are passed as an array
            },
        });

        // Update the post detail data
        await prisma.postDetail.update({
            where: { postId: id }, // Assuming there's a one-to-one relationship between Post and PostDetail
            data: {
